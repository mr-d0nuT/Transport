...
- **Tu tren de FGC avisa.** Sus alertas no van por línea sino por tren: «enlace en autobús con destino Igualada» (ese tren no llega en tren) o «los tres primeros coches» (el tren se parte). Salen en la tarjeta de esa salida concreta, emparejadas por el identificador del viaje.
