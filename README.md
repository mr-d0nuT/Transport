...
- **Sal a las 8:02.** Guarda también el trabajo (mantén pulsado el 🏠) y, cuando estés en casa o en la oficina, una sola línea te dice a qué hora salir, por dónde vas y a qué hora llegas, con el retraso real de cada tramo.
...
- **Sin escaleras.** Un interruptor en el menú de la cabecera: la app evita las estaciones sin ascensor (TMB publica la accesibilidad y los accesos de las 165 estaciones, y se consultan en vivo), avisa si el ascensor está averiado hoy, dice por qué acceso entrar («Ascensor: acceso Lisboa») y calcula las caminatas rodeando los escalones.
- **A tu paso.** La app mide con el GPS a qué velocidad andas en tus trayectos y calcula con eso todas las caminatas y los avisos de «no llegas» (el paso de manual, 4,5 km/h, no vale para todo el mundo). Se ve y se puede olvidar desde el menú.
- **Hasta la puerta.** Si el destino es un edificio o un recinto, la ruta lleva a su entrada real según OpenStreetMap, no al centro del polígono: en el Hospital de Sant Pau son 500 m de diferencia.
...
- **Si tu bus no va a llegar, te lo dice.** Yendo en el bus, la app mira lo que TMB prevé en tu parada de bajada: si allí espera otras líneas pero de la tuya ninguna, es que el tuyo va desviado (obras, una manifestación) y sale el aviso con el botón de recalcular. Solo lo dice si la parada habla de otras líneas, si bajas en menos de 25 minutos y si se repite en dos comprobaciones: no se deduce nada de un silencio.
- **Tus paradas, avisadas al abrir.** Si hoy no hay servicio en una parada de tus favoritas o de las que más usas, una línea arriba lo dice con las líneas afectadas y un botón para verla, en vez de enterarte cuando ya estás plantado allí. En el mapa esas paradas salen apagadas, y ahora también las del bus metropolitano.
- **Marquesina o poste.** La ficha dice si en esa parada se espera sentado y a cubierto o de pie: TMB lo publica abierto y AMB solo con clave, así que las 6.190 paradas metropolitanas llegan por el relé.
- **Y lo mismo en el bus metropolitano.** Los avisos de AMB traen las paradas afectadas y, en el texto oficial, el código de las alternativas: la ficha dice qué líneas se quedan sin esa parada, ofrece la alternativa más cercana con su nombre y a cuántos metros está (aunque sea de TMB: el aviso la escribe con ceros delante) y enlaza al plano del desvío. Hoy son 86 avisos activos sobre 221 paradas. El texto llega traducido gracias a la clave de AMB en el relé; sin relé se ve en catalán, que es como lo publica el feed abierto.
- **El itinerario accesible de verdad.** Con «Sin escaleras» puesto, cada tramo de FGC muestra su itinerario oficial de accesibilidad: por qué acceso entrar, en qué coche subir —«sube en el último coche», que en Valldoreix es lo que te deja frente al ascensor— y por dónde salir. Son las 2.762 combinaciones origen-destino que publica FGC, consultadas en vivo.
- **Tu tren de FGC avisa.** Sus alertas no van por línea sino por tren: «enlace en autobús con destino Igualada» (ese tren no llega en tren) o «los tres primeros coches» (el tren se parte). Salen en la tarjeta de esa salida concreta y en el detalle de la ruta, emparejadas por el identificador del viaje.
...
- **Te aviso yo.** En el bus o el metro, el panel dice cuántas paradas quedan y, en la penúltima, avisa con vibración y voz: «la próxima es la tuya, pulsa el timbre». Mientras caminas a la parada, la cuenta atrás de tu vehículo en directo; si te plantas en la parada del sentido contrario, te lo dice. La pantalla no se apaga durante el trayecto.
...
- **Modo túnel.** Bajo tierra no hay GPS, así que el trayecto sigue por tu propio vehículo: al subir se apunta cuál es (el tren por su número de servicio, el bus por su identificador, el de FGC por su viaje) y se le pregunta a la parada de bajada a qué hora llega. El panel sigue avanzando.
- **Comparte tu llegada.** Un enlace que sigue a tu vehículo: quien lo abre ve a qué hora llegas, actualizado solo. Sin servidor: el enlace lleva el identificador del vehículo y la parada.
